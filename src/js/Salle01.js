...
export default class Salle01 extends Phaser.Scene {
  ...
  create() {
    ...
    player = this.physics.add.sprite(330, 150, "dude.png");
    player.refreshBody();
    ...
    let msg = this.add.text(this.cameras.main.width / 2,
      this.cameras.main.height / 2, 'DIE !', { fontSize: '28px' });

    this.time.delayedCall(2000, () => {
      msg.destroy(); // disparaît après 2 secondes
    });
  }
